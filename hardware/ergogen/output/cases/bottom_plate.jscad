...
.union(
    ...
    new CSG.Path2D([[140.5,-115.15],[158.5,-115.15]]).appendPoint([158.5,-118.15]).appendPoint([177.5,-118.15]).appendPoint([177.5,-113.3875]).appendPoint([194.5,-113.3875]).appendPoint([194.5,-118.15]).appendPoint([212.5,-118.15]).appendPoint([212.5,-121.0075]).appendPoint([231.5,-121.0075]).appendPoint([231.5,-114.7717136]).appendArc([230.5414048,-113.0075],{"radius":1.5,"clockwise":false,"large":true}).appendPoint([213.5,-113.0075]).appendPoint([213.5,-110.15]).appendPoint([195.5,-110.15]).appendPoint([195.5,-105.3875]).appendPoint([176.5,-105.3875]).appendPoint([176.5,-110.15]).appendPoint([159.5,-110.15]).appendPoint([159.5,-109.9475469]).appendArc([159.4200095,-107.15],{"radius":1.5,"clockwise":false,"large":true}).appendPoint([140.5,-107.15]).appendPoint([140.5,-115.15]).close().innerToCAG()
